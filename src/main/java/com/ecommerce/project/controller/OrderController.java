...
public class OrderController {
    ...
    @PostMapping("/create")
    public ResponseEntity<Order> createOrder(@org.springframework.web.bind.annotation.RequestBody(required = false) OrderCreateRequest request, Authentication authentication) {
        ...
        Order order = orderService.createOrder(username, shippingAddress, phoneNumber);
