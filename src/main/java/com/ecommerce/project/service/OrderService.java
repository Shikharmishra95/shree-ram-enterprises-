...
public class OrderService {
    ...
    @Transactional
    public Order createOrder(String username, String shippingAddress, String phoneNumber) {
        // Load user
        ...
        if (shippingAddress == null || shippingAddress.trim().isEmpty()) {
            if (user.getAddresses() != null && !user.getAddresses().isEmpty()) {
                Address defaultAddr = user.getAddresses().get(0);
                shippingAddress = defaultAddr.getStreet() + ", " + defaultAddr.getCity() + ", " + defaultAddr.getState() + " - " + defaultAddr.getZipCode();
            } else {
